...
autocmd BufRead LIFE* set ts=2 shiftwidth=2 foldmethod=indent nocindent smartindent ignorecase syntax=life iskeyword=@,33-41,43-64,162-255 keywordprg=/opt/firefox/firefox
autocmd BufRead NOTAS* set ts=2 shiftwidth=2 foldmethod=indent nocindent smartindent ignorecase syntax=life iskeyword=@,33-41,43-64,162-255
